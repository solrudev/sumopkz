...
{
	Task Compress(CompressOperation operation, CancellationToken cancellationToken);
	Task Decompress(DecompressOperation operation, CancellationToken cancellationToken);
}
